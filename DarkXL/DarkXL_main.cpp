...
void DarkXL_Update(int32_t stage, f32 dt, XLEngine_Plugin_API *API, void *pUserData)
{
...
void DarkXL_Render(int32_t stage, f32 dt, XLEngine_Plugin_API *API, void *pUserData)
{
