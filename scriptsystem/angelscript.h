...
enum asEBCInstr
{
	...
	asBC_fTOi64			= 148,
	asBC_dTOi64			= 149,
	asBC_fTOuint64_t			= 150,
	asBC_dTOuint64_t			= 151,
	asBC_i64TOf			= 152,
	asBC_uint64_tTOf			= 153,
	asBC_i64TOd			= 154,
	asBC_uint64_tTOd			= 155,
	asBC_NEGi64			= 156,
	asBC_INCi64			= 157,
	asBC_DECi64			= 158,
	asBC_BNOT64			= 159,
	...
	asBC_DIVu			= 180,
	asBC_MODu			= 181,
	asBC_DIVuint64_t			= 182,
	asBC_MODuint64_t			= 183,
	asBC_LoadRObjR      = 184,
	asBC_LoadVObjR      = 185,
...
const asSBCInfo asBCInfo[256] =
{
	...
	asBCINFO(RDint8_t,		NO_ARG,			2-AS_PTR_SIZE),
	...
	asBCINFO(fTOuint64_t,	wW_rW_ARG,		0),
	asBCINFO(dTOuint64_t,	rW_ARG,			0),
	asBCINFO(i64TOf,	wW_rW_ARG,		0),
	asBCINFO(uint64_tTOf,	wW_rW_ARG,		0),
	asBCINFO(i64TOd,	rW_ARG,			0),
	asBCINFO(uint64_tTOd,	rW_ARG,			0),
	...
	asBCINFO(CMPuint64_t,	rW_rW_ARG,		0),
	...
	asBCINFO(DIVuint64_t,	wW_rW_rW_ARG,	0),
	asBCINFO(MODuint64_t,	wW_rW_rW_ARG,	0),
