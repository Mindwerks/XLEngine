...
public:
    ...
    void Render(int32_t frame, float x = 0.0f, float y = 0.0f, float maxX = 1.0f, float minY = 0.0f, float dU = 0.0f,
                float dV = 0.0f, bool bDistort = false);

    void GetFrameExtents(int32_t frame, float x, float y, int32_t &frameX0, int32_t &frameY0, int32_t &frameWidth,
                         int32_t &frameHeight);
