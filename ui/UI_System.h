...
private:
    ...
    static UI_Window *
    AddWindow(const string &sName, const string &sText, uint32_t uType, int32_t x, int32_t y, int32_t w, int32_t h,
              uint32_t flags, UI_Window *parent = NULL);
    ...
    static void
    UI_RenderImageRect(int hImage, int x, int y, int w, int h, float intensity, int alignHoriz, int alignVert);
    ...
    static void
    UI_RenderPolygon(int npt, asIScriptArray *x, asIScriptArray *y, float r, float g, float b, float a, int alignHoriz,
                     int alignVert);

    static void
    UI_RenderRect(int x, int y, int w, int h, float r, float g, float b, float a, int alignHoriz, int alignVert);
