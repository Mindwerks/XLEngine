...
bool XL_Console::Init(IDriver3D *pDriver) {
    ...
    s_pConsole->AddItem("con_tex", (void *) _ConsoleTex, Console::CTYPE_FUNCTION,
                        "Load a new console background texture.");
...
void XL_Console::RegisterCmd(const string &itemName, void *ptr, Console::ConsoleItemType type, const string &itemHelp,
                             void *pUserData) {
