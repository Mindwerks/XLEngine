...
void Matrix::AxisAngle(Vector3 &axis, float angle) {
    ...
    rot.m[0] = ca + axis.x * axis.x * (1.0f - ca);
    rot.m[4] = axis.x * axis.y * (1.0f - ca) - axis.z * sa;
    rot.m[8] = axis.x * axis.z * (1.0f - ca) + axis.y * sa;
    rot.m[1] = axis.y * axis.x * (1.0f - ca) + axis.z * sa;
    rot.m[5] = ca + axis.y * axis.y * (1.0f - ca);
    rot.m[9] = axis.y * axis.z * (1.0f - ca) - axis.x * sa;
    rot.m[2] = axis.z * axis.x * (1.0f - ca) - axis.y * sa;
    rot.m[6] = axis.z * axis.y * (1.0f - ca) + axis.x * sa;
    rot.m[10] = ca + axis.z * axis.z * (1.0f - ca);
