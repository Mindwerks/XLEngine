...
public:
    ...
    inline bool operator==(Vector3 &other) {
        return (fabsf(x - other.x) < VEC_EPS && fabsf(y - other.y) < VEC_EPS && fabsf(z - other.z) < VEC_EPS) ? (true)
                                                                                                              : (false);
    }
    ...
    inline void MinVec(Vector3 &b) {
        this->x = MINS(this->x, b.x);
        this->y = MINS(this->y, b.y);
        this->z = MINS(this->z, b.z);
    }

    inline void MaxVec(Vector3 &b) {
        this->x = MAXS(this->x, b.x);
        this->y = MAXS(this->y, b.y);
        this->z = MAXS(this->z, b.z);
    }
