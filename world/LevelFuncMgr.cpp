...
void LevelFuncMgr::AddLevelFuncCB(const string &sFuncName, LevelFunc::LFunc_ActivateCB pActivate,
                                  LevelFunc::LFunc_SetValueCB pSetValue) {
