...
public:
    ...
    inline static void SetMouseDelta(int32_t dx, int32_t dy) {
        m_fMouseDeltaX = (float) dx;
        m_fMouseDeltaY = (float) dy;
    }

    inline static void AddMouseDelta(int32_t dx, int32_t dy) {
        m_fMouseDeltaX += (float) dx;
        m_fMouseDeltaY += (float) dy;
    }

    inline static void GetMouseDelta(float &dx, float &dy) {
        dx = m_fMouseDeltaX;
        dy = m_fMouseDeltaY;
    }
